@echo off
set CompilerFlags=-MT -nologo -EHsc -EHa- -GR- -Od -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4459 -wd4456 -wd4702 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -Z7 -Fmwin32_handmade.map
